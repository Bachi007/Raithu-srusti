...
<form action="suplogvalid.jsp" method="Get"  onsubmit=" return check()">
...
<tr><td>pass word:</td><td><input type="password"  id="pswd" placeholder=" enter password" name="pswd"></td>
...
<center>forget password...?&nbsp;<a href="sforgetpassword.jsp">register here</a></center>
