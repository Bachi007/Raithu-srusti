...
<span align="center"><h2> <u>feedback details</u></h2> </span>
<% 
...
ResultSet res=ps.executeQuery("select * from feedback");
if(!res.next())
{
	%>
	<font color='red' size='6'><center> no farmers feedback</center></font>
...
<table border="4"><br>
 <th width="127">user name</th>
 <th width="127">user type</th>
 <th width="127"> feedback</th>
 <th width="127"> description</th>
   <th width="127">rating</th>
</tr>
<% do
	{
	%>
